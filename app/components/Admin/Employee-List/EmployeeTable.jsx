            ...
            {users.map((user) => (
              ...
              >
                ...
                <td className="py-4 px-0 whitespace-nowrap">
                  <button className="text-[18px] bg-blue-900 text-white py-2 px-4 rounded-2xl cursor-pointer font-semibold hover:bg-blue-700 transition-all">
                    <FontAwesomeIcon icon="up-right-and-down-left-from-center" className="mr-2.5"/>
                    view assets
                  </button>
                </td>
              </tr>
