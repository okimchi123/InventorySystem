  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        animate="visible"
        exit="exit"
        className={`fixed flex justify-center items-center gap-[8px] left-[45%] top-[10%] z-100 py-5 px-3 rounded-lg shadow-lg text-white ${isSuccess ? "bg-[#11B823]" : "bg-red-500"
          }`}
      >
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50 bg-gray-900/75">
      ...
      >
        ...
        <div className="flex justify-end gap-2 self-end">
          <button onClick={onConfirm} className="px-4 py-2 cursor-pointer transition-all bg-green-600 text-white rounded-lg hover:bg-green-700">Confirm</button>
        </div>
      </motion.div>
    </div>
  );
